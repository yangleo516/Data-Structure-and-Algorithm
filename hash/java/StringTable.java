...
/**
 * Create a table and initialized it with size 2.
 */
      public StringTable(int maxSize){
    	table = new Record[maxSize/maxSize + 1];
    }
    
    /**
     * double the old table
     */
    ...
    { 
    	...
    	for(int i = 0; i < size; i++){
    		...
    		//			+ "   Position in tale: "+slot+ "   Key: " + table[slot].key); 
    			...
    			//detect if load factor is bigger than 0.25
    			//If if does, call doubleTable method to double the old table.
    			//Call reHash method to rehash records into the double-size table.
    ...
    /**
     * Rehash all records(inputs) in the old table into the new one with double size. 
     * @param oldTable
     */
